...
* [x] Run `golem apidoc` to regenerate `docs/api/` from source (these files are excluded from git).
* [x] Run `golem check --strict` to verify syntax and semantic resolver rules without writing build output.
* [x] Run `golem build --strict` to ensure zero compilation warnings and build artifacts.
